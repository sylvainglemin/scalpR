...
#' This corresponds to the null model with only mutation bias, which is a function of the intercept and GC content
#'
...
#' @param GC: GC content
#'
#' @return A list with the intercetp, the mutational bias and the weighted total sum of squares
#'
#' @examples
...
sum_of_squares_M <- function(WS,SW,GC) {
  ...
  return(
    list(
      "mean" = y_mean,
      "mutabias"=exp(y_mean + log(GC) - log(1 - GC)),
...
#' @title Sum of squares of the model with constant B but not mutation bias
#'
...
#' @title Sum of squares of the model with constant gBGC and mutation bias
#'
#' @description Function that return the weighted sum of squares between the function of the SFSs and error rates and the linear predictor.
